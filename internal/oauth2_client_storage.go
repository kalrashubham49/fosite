...
// Source: github.com/kalrashubham49/fosite/handler/oauth2 (interfaces: ClientCredentialsGrantStorage)
...
func (m *MockClientCredentialsGrantStorage) GetAccessTokenSession(arg0 context.Context, arg1 string) (fosite.Requester, error) {
	m.ctrl.T.Helper()
